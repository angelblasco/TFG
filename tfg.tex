...
Ahora asumimos que $V$ y $W$ son FG-m'odulos isomorfos. Por (1) hay una base $\mathscr{B}_{1}$ de $V$ y una base $\mathscr{B}_{2}$ de $W$ tal que $[g]_{\mathscr{B}_{1}}=[g]_{\mathscr{B}_{2}}$ para todo $g \in G$.
\end{proof}
