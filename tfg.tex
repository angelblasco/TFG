...
Veremos la relaci'on entre los automorfismos de un grupo, sus automorfismos interiores y su centro. El centro de un grupo, simbolizado por $Z(G)$ es un grupo normal de $G$ el cual esta definido por
\[
...
a \mapsto x^{-1}ax
\]
es un automorfismo de $G$ y se denomina \textbf{automorfismo interior} de $G$ determinado por $x$.
\end{definicion}
\begin{teorema}
