...
\end{proof}
\section{Caracter de una representaci'on.}
Para comprender lo que es el caracter de una representaci'on necesitamos conocer primero el concepto de traza. Este concepto se estudi'o en los primeros cursos de Algebra Lineal, pero debido a su importancia en esta secci'on procedemos, de nuevo, a dar su definici'on:
\begin{definicion}
