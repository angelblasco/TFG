...
Sean $V$ y $W$ dos $\mathbb{C}$G-m'odulos irreducibles.
\begin{enumerate}
\item Si $\vartheta : V \rightarrow W$ es un $\mathbb{C}$G-homomorfismo, entonces, o bien $\vartheta$ es un $\mathbb{C}$G-isomorfismo, o $\vartheta (v)=0$ para todo $v \in V$.
\item Si $\vartheta : V \rightarrow W$ es un $\mathbb{C}$G-isomorfismo, entonces $\vartheta$ es un escalar del endomorfismo identidad $1_{V}$. 
\end{enumerate}
\end{teorema}
\begin{proof}
Supongamos que $\vartheta(v)=0$ para alg'un $v \in V$. Entonces Im($\vartheta$)$\neq 0$.
\end{proof}
%%% Capitulo 4
\chapter{Capitulo 4.}
\newpage
